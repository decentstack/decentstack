...
class PeerConnection extends EventEmitter {
  ...
  kill (err = null) {
    ...
    const cleanup = () => {
      ...
      this.stream.removeListener('feed', this._onRemoteFeedJoined)
      this.virtualFeed.removeListener('extension', this._onExt)
      this.stream.removeListener('prefinalize', this._prefinalize)
