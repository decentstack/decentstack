  ...
  constructor (initiator, exchangeKey, opts = {}) {
    ...
    this.exchangeChannel = this.stream.open(this.exchangeKey, {
      ...
      onopen: () => {
        ...
        // TODO: Prevent exchange channel from closing in non-live mode
        // while an active exchange is on going. there should be a timeout for
        // how long each peer waits until the other side either sends a manifest
        // or (replication requests are already timed)
